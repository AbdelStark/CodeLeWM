...
class LLMWorldModelDemoTest(unittest.TestCase):
    def test_runner_writes_manifested_fixture_demo_report(self) -> None:
        ...
        self.assertIn("inference_trace", view_model)
        self.assertEqual(view_model["inference_trace"]["latent_details"]["status"], "not_recorded")
        ...
        self.assertIn("World-model inference", html)
