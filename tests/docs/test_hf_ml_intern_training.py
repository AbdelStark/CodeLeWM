...
class HFMLInternTrainingDocsTest(unittest.TestCase):
    ...
    def test_next_goal_points_to_hf_goal_prompt(self) -> None:
        ...
        self.assertIn("completion record for the final v1.0 paper/demo release tracker #401", text)
        self.assertIn("#402 - complete", text)
        self.assertIn("#405 - complete", text)
        self.assertIn("#406 - complete", text)
        self.assertIn("#407 - complete", text)
        self.assertIn("#408 - complete", text)
        self.assertIn("docs/benchmark/PAPER_DEMO_V1_0_ARTIFACTS_2026-06-08.md", text)
        self.assertIn("docs/benchmark/V1_0_FINAL_CLAIM_AUDIT_2026-06-08.md", text)
        self.assertIn("docs/benchmark/PUBLIC_ARTIFACT_INDEX_2026-06-08.md", text)
        self.assertIn("docs/release/V1_0_REPRODUCIBILITY_CHECKLIST_2026-06-08.md", text)
        self.assertIn("docs/announcements/FINAL_V1_0_RELEASE_2026-06-08.md", text)
        self.assertIn("docs/papers/codelewm_final_paper.tex", text)
        self.assertIn("docs/papers/codelewm_final_claim_audit.md", text)
        ...
        self.assertIn("Issue #408 was the final release package", normalized)
        self.assertIn("No active final release child issue remains.", normalized)
