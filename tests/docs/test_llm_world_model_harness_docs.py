...
class LLMWorldModelHarnessDocsTest(unittest.TestCase):
    def test_spec_locks_openrouter_and_claim_boundary(self) -> None:
        ...
        for marker in (
            ...
            "codelewm.harness.paper_demo_report.v1",
            "docs/benchmark/v0_9/seed-{42,1729}/rerank/humaneval/",
            "docs/benchmark/v0_9/seed-{42,1729}/rerank/mbpp_plus/",
            "downstream_benchmark-f015b6696b3e29e1",
            "downstream_benchmark-f8aaaa3b3c1eb910",
            "training_run-992f7757f2780da4",
            "training_run-91e9cf7c645379b3",
            ...
            "lexical baseline",
            "no-action baseline",
            "retrieval-prior-only or ensemble baselines",
            "pass@1, pass@5, MRR",
            "reports/paper_demo_report.json",
            "reports/paper_demo_table.md",
            "HumanEval WS-D is positive, but MBPP-Plus is saturated",
        ):
