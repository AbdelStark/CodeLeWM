...
and #240 closed run-timeline reports.
Select one open stream before making changes:
#227 through #231 for the meaningful harness demo, #241 through #245 for the
...
#239 closed latent matrix diagnostics, #240 closed run timelines, #242 preserves
