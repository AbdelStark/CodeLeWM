...
1. #159: run the second-stage action-use remediation sweep if the project is
   ...
   required first.
2. #125: docs: refresh public docs against verified scaled evidence and the
   final claim boundary.
3. #126: release: run final artifact freeze and checklist.
...
audit and release provenance gates, #137 HF Jobs automation, #138 first scaled
HF execution, #151 no-action claim gates, #152 action-discriminative
diagnostics, #153 action-use margin training configs, and #154 primary
action-use HF execution.
...
- #159, #125, and #126 are closed by merged PRs, or any remaining
