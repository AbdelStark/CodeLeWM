...
- #235 through #245 define the visual observability stream. #237 adds optional
  ...
  terminal, and HTML outputs. The remaining queue is optional Textual TUI mode,
  demo diagnostic links, diagnostics-driven model experiment planning, and one
  visual artifact publication.
