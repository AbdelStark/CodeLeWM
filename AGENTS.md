...
and the optional Textual TUI. Issue #241 added the optional `tui` dependency
group, `codelewm llm-demo-tui`, `scripts/llm-world-model-demo --tui`, and
deterministic `codelewm.harness.demo_tui_snapshot.v1` fixture snapshots.
